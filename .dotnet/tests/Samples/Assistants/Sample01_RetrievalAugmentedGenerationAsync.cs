...
//             Assistant assistant = await assistantClient.CreateAssistantAsync("gpt-4-1106-preview", assistantOptions);
...
//             ListQueryPage<ThreadMessage> messages = await assistantClient.GetMessagesAsync(threadRun.ThreadId);
