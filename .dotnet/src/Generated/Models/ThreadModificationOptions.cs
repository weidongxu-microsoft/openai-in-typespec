...
namespace OpenAI.Assistants
{
    ...
    public partial class ThreadModificationOptions
    {
        ...
        internal ThreadModificationOptions(ToolResourceDefinitions toolResources, IDictionary<string, string> metadata, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
