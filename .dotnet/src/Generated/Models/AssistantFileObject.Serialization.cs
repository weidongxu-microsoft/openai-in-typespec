...
namespace OpenAI.Internal.Models
{
    internal partial class AssistantFileObject : IJsonModel<AssistantFileObject>
    {
        void IJsonModel<AssistantFileObject>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AssistantFileObject)} does not support writing '{format}' format.");
            }
        ...
        AssistantFileObject IJsonModel<AssistantFileObject>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AssistantFileObject)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AssistantFileObject>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AssistantFileObject)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        AssistantFileObject IPersistableModel<AssistantFileObject>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AssistantFileObject)} does not support reading '{options.Format}' format.");
            }
        }
