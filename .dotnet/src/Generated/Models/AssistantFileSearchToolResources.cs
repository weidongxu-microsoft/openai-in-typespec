...
namespace OpenAI.Assistants
{
    ...
    public partial class AssistantFileSearchToolResources
    {
        ...
        /// <summary> Initializes a new instance of <see cref="AssistantFileSearchToolResources"/>. </summary>
        internal AssistantFileSearchToolResources()
        {
        ...
        internal AssistantFileSearchToolResources(IReadOnlyList<string> vectorStoreIds, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
