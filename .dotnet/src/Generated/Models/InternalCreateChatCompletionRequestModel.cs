...
namespace OpenAI.Chat
{
    ...
    internal readonly partial struct InternalCreateChatCompletionRequestModel : IEquatable<InternalCreateChatCompletionRequestModel>
    {
        ...
        /// <summary> Initializes a new instance of <see cref="InternalCreateChatCompletionRequestModel"/>. </summary>
        ...
        /// <summary> Determines if two <see cref="InternalCreateChatCompletionRequestModel"/> values are the same. </summary>
        ...
        /// <summary> Determines if two <see cref="InternalCreateChatCompletionRequestModel"/> values are not the same. </summary>
        public static bool operator !=(InternalCreateChatCompletionRequestModel left, InternalCreateChatCompletionRequestModel right) => !left.Equals(right);
        /// <summary> Converts a string to a <see cref="InternalCreateChatCompletionRequestModel"/>. </summary>
