...
{
    internal partial class InternalUnknownRunStepObjectStepDetails : IJsonModel<RunStepDetails>
    {
        ...
        internal static InternalUnknownRunStepObjectStepDetails DeserializeInternalUnknownRunStepObjectStepDetails(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new InternalUnknownRunStepObjectStepDetails(type, serializedAdditionalRawData);
        }
        ...
        internal static new InternalUnknownRunStepObjectStepDetails FromResponse(PipelineResponse response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializeInternalUnknownRunStepObjectStepDetails(document.RootElement);
        }

        /// <summary> Convert into a <see cref="BinaryContent"/>. </summary>
        internal override BinaryContent ToBinaryContent()
        {
            return BinaryContent.Create<RunStepDetails>(this, ModelSerializationExtensions.WireOptions);
        }
    }
}
