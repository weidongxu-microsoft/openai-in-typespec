...
namespace OpenAI.Internal.Models
{
    internal partial class ListRunsResponse : IJsonModel<ListRunsResponse>
    {
        void IJsonModel<ListRunsResponse>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ListRunsResponse)} does not support writing '{format}' format.");
            }
            ...
            {
                writer.WriteObjectValue<RunObject>(item, options);
            }
        ...
        ListRunsResponse IJsonModel<ListRunsResponse>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ListRunsResponse)} does not support reading '{format}' format.");
            }
        ...
        internal static ListRunsResponse DeserializeListRunsResponse(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("data"u8))
                {
                    ...
                    {
                        array.Add(RunObject.DeserializeRunObject(item, options));
                    }
                    data = array;
                    continue;
                }
        ...
        BinaryData IPersistableModel<ListRunsResponse>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ListRunsResponse)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        ListRunsResponse IPersistableModel<ListRunsResponse>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ListRunsResponse)} does not support reading '{options.Format}' format.");
            }
        }
