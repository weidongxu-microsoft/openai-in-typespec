...
namespace OpenAI.Assistants
{
    internal partial class UnknownRunStepObjectStepDetails : IJsonModel<RunStepDetails>
    {
        ...
        internal static UnknownRunStepObjectStepDetails DeserializeUnknownRunStepObjectStepDetails(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new UnknownRunStepObjectStepDetails(type, serializedAdditionalRawData);
        }
        ...
        internal static new UnknownRunStepObjectStepDetails FromResponse(PipelineResponse response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializeUnknownRunStepObjectStepDetails(document.RootElement);
        }
