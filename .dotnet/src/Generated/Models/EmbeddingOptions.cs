...
namespace OpenAI.Embeddings
{
    ...
    public partial class EmbeddingOptions
    {
        ...
        internal EmbeddingOptions(BinaryData input, CreateEmbeddingRequestModel model, EmbeddingOptionsEncodingFormat? encodingFormat, long? dimensions, string user, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Input = input;
            Model = model;
