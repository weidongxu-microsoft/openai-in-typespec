...
{
    /// <summary> The CreateThreadRequestToolResourcesCodeInterpreter. </summary>
    internal partial class CreateThreadRequestToolResourcesCodeInterpreter
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="CreateThreadRequestToolResourcesCodeInterpreter"/>. </summary>
        ...
        internal CreateThreadRequestToolResourcesCodeInterpreter(IList<string> fileIds, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            FileIds = fileIds;
