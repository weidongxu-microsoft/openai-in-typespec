...
namespace OpenAI.Internal.Models
{
    ...
    internal partial class CreateAssistantRequest
    {
        ...
        internal CreateAssistantRequest(string model, string name, string description, string instructions, IList<BinaryData> tools, IList<string> fileIds, IDictionary<string, string> metadata, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Model = model;
            Name = name;
