...
namespace OpenAI.Internal.Models
{
    ...
    internal partial class VectorStoreFileObject
    {
        /// <summary>
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="id"/> or <paramref name="vectorStoreId"/> is null. </exception>
        ...
        internal VectorStoreFileObject(string id, VectorStoreFileObjectObject @object, int usageBytes, DateTimeOffset createdAt, string vectorStoreId, VectorStoreFileObjectStatus status, VectorStoreFileObjectLastError lastError, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Object = @object;
            UsageBytes = usageBytes;
        ...
        /// <summary> Initializes a new instance of <see cref="VectorStoreFileObject"/> for deserialization. </summary>
        ...
        public VectorStoreFileObjectObject Object { get; } = VectorStoreFileObjectObject.VectorStoreFile;
