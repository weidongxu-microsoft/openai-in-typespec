...
namespace OpenAI.Assistants
{
    ...
    /// </summary>
    public abstract partial class RunStepToolCallDetails
    {
        /// <summary>
        ...
        protected RunStepToolCallDetails()
        {
        }
        ...
        internal RunStepToolCallDetails(string type, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Type = type;
