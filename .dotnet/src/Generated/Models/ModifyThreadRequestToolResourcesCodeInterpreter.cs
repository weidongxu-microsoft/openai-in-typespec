...
{
    /// <summary> The ModifyThreadRequestToolResourcesCodeInterpreter. </summary>
    internal partial class ModifyThreadRequestToolResourcesCodeInterpreter
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="ModifyThreadRequestToolResourcesCodeInterpreter"/>. </summary>
        ...
        internal ModifyThreadRequestToolResourcesCodeInterpreter(IList<string> fileIds, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            FileIds = fileIds;
