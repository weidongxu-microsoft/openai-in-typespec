...
namespace OpenAI.Internal.Models
{
    internal partial class FunctionParameters : IJsonModel<FunctionParameters>
    {
        void IJsonModel<FunctionParameters>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(FunctionParameters)} does not support writing '{format}' format.");
            }
        ...
        FunctionParameters IJsonModel<FunctionParameters>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(FunctionParameters)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<FunctionParameters>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(FunctionParameters)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        FunctionParameters IPersistableModel<FunctionParameters>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(FunctionParameters)} does not support reading '{options.Format}' format.");
            }
        }
