...
namespace OpenAI.Assistants
{
    ...
    public partial class AssistantCodeInterpreterToolResources
    {
        ...
        /// <summary> Initializes a new instance of <see cref="AssistantCodeInterpreterToolResources"/>. </summary>
        internal AssistantCodeInterpreterToolResources()
        {
        ...
        internal AssistantCodeInterpreterToolResources(IReadOnlyList<string> fileIds, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            FileIds = fileIds;
