...
{
    public partial class RunStepCodeInterpreterLogOutput : IJsonModel<RunStepCodeInterpreterLogOutput>
    {
        ...
        internal static new RunStepCodeInterpreterLogOutput FromResponse(PipelineResponse response)
        {
