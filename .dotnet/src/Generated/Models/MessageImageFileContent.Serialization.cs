...
{
    public partial class MessageImageFileContent : IJsonModel<MessageImageFileContent>
    {
        ...
        internal static MessageImageFileContent DeserializeMessageImageFileContent(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new MessageImageFileContent(serializedAdditionalRawData, type, imageFile);
        }
        ...
        internal static new MessageImageFileContent FromResponse(PipelineResponse response)
        {
