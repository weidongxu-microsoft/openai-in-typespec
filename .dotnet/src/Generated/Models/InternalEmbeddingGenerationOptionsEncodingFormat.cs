...
{
    /// <summary> Enum for encoding_format in EmbeddingGenerationOptions. </summary>
    internal readonly partial struct InternalEmbeddingGenerationOptionsEncodingFormat : IEquatable<InternalEmbeddingGenerationOptionsEncodingFormat>
    {
        ...
        /// <summary> Initializes a new instance of <see cref="InternalEmbeddingGenerationOptionsEncodingFormat"/>. </summary>
        ...
        /// <summary> Determines if two <see cref="InternalEmbeddingGenerationOptionsEncodingFormat"/> values are the same. </summary>
        ...
        /// <summary> Determines if two <see cref="InternalEmbeddingGenerationOptionsEncodingFormat"/> values are not the same. </summary>
        public static bool operator !=(InternalEmbeddingGenerationOptionsEncodingFormat left, InternalEmbeddingGenerationOptionsEncodingFormat right) => !left.Equals(right);
        /// <summary> Converts a string to a <see cref="InternalEmbeddingGenerationOptionsEncodingFormat"/>. </summary>
