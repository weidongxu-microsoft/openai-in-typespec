...
{
    internal partial class MessageFileObject : IJsonModel<MessageFileObject>
    {
        void IJsonModel<MessageFileObject>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MessageFileObject)} does not support writing '{format}' format.");
            }
        ...
        MessageFileObject IJsonModel<MessageFileObject>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MessageFileObject)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<MessageFileObject>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(MessageFileObject)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        MessageFileObject IPersistableModel<MessageFileObject>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(MessageFileObject)} does not support reading '{options.Format}' format.");
            }
        }
