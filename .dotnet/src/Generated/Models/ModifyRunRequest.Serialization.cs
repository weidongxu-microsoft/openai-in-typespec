...
namespace OpenAI.Internal.Models
{
    internal partial class ModifyRunRequest : IJsonModel<ModifyRunRequest>
    {
        void IJsonModel<ModifyRunRequest>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ModifyRunRequest)} does not support writing '{format}' format.");
            }
        ...
        ModifyRunRequest IJsonModel<ModifyRunRequest>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ModifyRunRequest)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ModifyRunRequest>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ModifyRunRequest)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        ModifyRunRequest IPersistableModel<ModifyRunRequest>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ModifyRunRequest)} does not support reading '{options.Format}' format.");
            }
        }
