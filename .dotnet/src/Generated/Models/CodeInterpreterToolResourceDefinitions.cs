...
namespace OpenAI.Assistants
{
    ...
    public partial class CodeInterpreterToolResourceDefinitions
    {
        ...
        /// <summary> Initializes a new instance of <see cref="CodeInterpreterToolResourceDefinitions"/>. </summary>
        public CodeInterpreterToolResourceDefinitions()
        {
        ...
        internal CodeInterpreterToolResourceDefinitions(IList<string> fileIds, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            FileIds = fileIds;
