...
{
    internal partial class TruncationObject : IJsonModel<TruncationObject>
    {
        ...
        internal static TruncationObject DeserializeTruncationObject(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            TruncationObjectType type = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    type = new TruncationObjectType(property.Value.GetString());
                    continue;
                }
        ...
        internal static TruncationObject FromResponse(PipelineResponse response)
        {
