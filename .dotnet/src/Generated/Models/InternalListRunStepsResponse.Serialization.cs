...
namespace OpenAI.Assistants
{
    internal partial class InternalListRunStepsResponse : IJsonModel<InternalListRunStepsResponse>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<InternalListRunStepsResponse>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        InternalListRunStepsResponse IJsonModel<InternalListRunStepsResponse>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<InternalListRunStepsResponse>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static InternalListRunStepsResponse DeserializeInternalListRunStepsResponse(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<InternalListRunStepsResponse>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<InternalListRunStepsResponse>)this).GetFormatFromOptions(options) : options.Format;
        ...
        InternalListRunStepsResponse IPersistableModel<InternalListRunStepsResponse>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<InternalListRunStepsResponse>)this).GetFormatFromOptions(options) : options.Format;
        ...
        internal static InternalListRunStepsResponse FromResponse(PipelineResponse response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializeInternalListRunStepsResponse(document.RootElement);
        }
