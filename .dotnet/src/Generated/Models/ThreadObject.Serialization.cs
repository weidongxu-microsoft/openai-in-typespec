...
namespace OpenAI.Internal.Models
{
    internal partial class ThreadObject : IJsonModel<ThreadObject>
    {
        void IJsonModel<ThreadObject>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ThreadObject)} does not support writing '{format}' format.");
            }
        ...
        ThreadObject IJsonModel<ThreadObject>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ThreadObject)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ThreadObject>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ThreadObject)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        ThreadObject IPersistableModel<ThreadObject>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ThreadObject)} does not support reading '{options.Format}' format.");
            }
        }
