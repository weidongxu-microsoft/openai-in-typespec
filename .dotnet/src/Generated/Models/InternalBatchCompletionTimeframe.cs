...
namespace OpenAI.Batch
{
    ...
    internal readonly partial struct InternalBatchCompletionTimeframe : IEquatable<InternalBatchCompletionTimeframe>
    {
        ...
        /// <summary> Initializes a new instance of <see cref="InternalBatchCompletionTimeframe"/>. </summary>
        ...
        /// <summary> Determines if two <see cref="InternalBatchCompletionTimeframe"/> values are the same. </summary>
        ...
        /// <summary> Determines if two <see cref="InternalBatchCompletionTimeframe"/> values are not the same. </summary>
        public static bool operator !=(InternalBatchCompletionTimeframe left, InternalBatchCompletionTimeframe right) => !left.Equals(right);
        /// <summary> Converts a string to a <see cref="InternalBatchCompletionTimeframe"/>. </summary>
