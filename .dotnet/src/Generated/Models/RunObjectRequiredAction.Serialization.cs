...
{
    internal partial class RunObjectRequiredAction : IJsonModel<RunObjectRequiredAction>
    {
        void IJsonModel<RunObjectRequiredAction>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RunObjectRequiredAction)} does not support writing '{format}' format.");
            }
            ...
            writer.WriteObjectValue<RunObjectRequiredActionSubmitToolOutputs>(SubmitToolOutputs, options);
        ...
        RunObjectRequiredAction IJsonModel<RunObjectRequiredAction>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RunObjectRequiredAction)} does not support reading '{format}' format.");
            }
        ...
        internal static RunObjectRequiredAction DeserializeRunObjectRequiredAction(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    submitToolOutputs = RunObjectRequiredActionSubmitToolOutputs.DeserializeRunObjectRequiredActionSubmitToolOutputs(property.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
        ...
        BinaryData IPersistableModel<RunObjectRequiredAction>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(RunObjectRequiredAction)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        RunObjectRequiredAction IPersistableModel<RunObjectRequiredAction>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(RunObjectRequiredAction)} does not support reading '{options.Format}' format.");
            }
        }
