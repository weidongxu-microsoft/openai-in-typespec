...
namespace OpenAI.Internal.Models
{
    ...
    internal partial class ModifyThreadRequest
    {
        ...
        internal ModifyThreadRequest(ModifyThreadRequestToolResources toolResources, IDictionary<string, string> metadata, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
