...
namespace OpenAI.Internal.Models
{
    ...
    internal partial class ListThreadsResponse
    {
        /// <summary>
        ...
        internal ListThreadsResponse(string @object, IReadOnlyList<ThreadObject> data, string firstId, string lastId, bool hasMore, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Object = @object;
            Data = data;
            FirstId = firstId;
        ...
        /// <summary> Initializes a new instance of <see cref="ListThreadsResponse"/> for deserialization. </summary>
        internal ListThreadsResponse()
        {
        }
