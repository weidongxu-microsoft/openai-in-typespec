...
namespace OpenAI.Internal.Models
{
    ...
    internal partial class AssistantObjectToolResourcesCodeInterpreter
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="AssistantObjectToolResourcesCodeInterpreter"/>. </summary>
        internal AssistantObjectToolResourcesCodeInterpreter()
        {
        ...
        internal AssistantObjectToolResourcesCodeInterpreter(IReadOnlyList<string> fileIds, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            FileIds = fileIds;
