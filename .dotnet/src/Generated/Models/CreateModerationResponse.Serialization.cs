...
{
    internal partial class CreateModerationResponse : IJsonModel<CreateModerationResponse>
    {
        void IJsonModel<CreateModerationResponse>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            {
                writer.WriteObjectValue<CreateModerationResponseResult>(item, options);
            }
