...
namespace Azure.AI.OpenAI
{
    internal partial class InternalAzureOpenAIChatErrorInnerError : IJsonModel<InternalAzureOpenAIChatErrorInnerError>
    {
        ...
        internal static InternalAzureOpenAIChatErrorInnerError DeserializeInternalAzureOpenAIChatErrorInnerError(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            InternalAzureContentFilterResultForPrompt contentFilterResults = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("content_filter_results"u8))
                {
                    ...
                    contentFilterResults = InternalAzureContentFilterResultForPrompt.DeserializeInternalAzureContentFilterResultForPrompt(property.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
