...
{
    public partial class AzureChatSearchDataSourceParameters : IJsonModel<AzureChatSearchDataSourceParameters>
    {
        ...
        internal static AzureChatSearchDataSourceParameters FromResponse(PipelineResponse response)
        {
