...
public class VectorStoreTests
{
    ...
    {
        FileClient fileClient = GetQuietTestFileClient();
        VectorStoreClient vectorStoreClient = GetQuietTestVectorStoreClient();
    ...
    private static AzureOpenAIClient GetAzureClient(bool useDebugOutput)
    {
    ...
    private static VectorStoreClient GetTestClient() => GetAzureClient(true).GetVectorStoreClient();
    private static VectorStoreClient GetQuietTestVectorStoreClient() => GetAzureClient(false).GetVectorStoreClient();
    private static FileClient GetQuietTestFileClient() => GetAzureClient(false).GetFileClient();
