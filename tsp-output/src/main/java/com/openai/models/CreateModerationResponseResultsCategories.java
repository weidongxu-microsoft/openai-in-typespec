...
/**
 * The CreateModerationResponseResultsCategories model.
 */
@Metadata(conditions = { TypeConditions.IMMUTABLE })
public final class CreateModerationResponseResultsCategories
    implements JsonSerializable<CreateModerationResponseResultsCategories> {
    /*
    ...
    /**
     * Creates an instance of CreateModerationResponseResultsCategories class.
     * 
     ...
     */
    @Metadata(generated = true)
    private CreateModerationResponseResultsCategories(boolean hate, boolean hateThreatening, boolean harassment,
        boolean harassmentThreatening, boolean selfHarm, boolean selfHarmIntent, boolean selfHarmInstructions,
    ...
    /**
     * Reads an instance of CreateModerationResponseResultsCategories from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of CreateModerationResponseResultsCategories if the JsonReader was pointing to an instance of
     * it, or null if it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the CreateModerationResponseResultsCategories.
     */
    @Metadata(generated = true)
    public static CreateModerationResponseResultsCategories fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            return new CreateModerationResponseResultsCategories(hate, hateThreatening, harassment,
