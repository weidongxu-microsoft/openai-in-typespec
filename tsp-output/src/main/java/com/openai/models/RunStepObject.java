...
public final class RunStepObject implements JsonSerializable<RunStepObject> {
     ...
     */
    @Metadata(generated = true)
    private final BinaryData stepDetails;
    ...
    private RunStepObject(String id, OffsetDateTime createdAt, String assistantId, String threadId, String runId,
        RunStepObjectType type, RunStepObjectStatus status, BinaryData stepDetails, RunStepObjectLastError lastError,
        OffsetDateTime expiresAt, OffsetDateTime cancelledAt, OffsetDateTime failedAt, OffsetDateTime completedAt,
        Map<String, String> metadata, RunStepCompletionUsage usage) {
        this.id = id;
        if (createdAt == null) {
            this.createdAt = 0L;
        } else {
     ...
     */
    @Metadata(generated = true)
    public BinaryData getStepDetails() {
    ...
    /**
     * Get the expiresAt property: The Unix timestamp (in seconds) for when the run step expired. A step is considered
     * expired
     * if the parent run is expired.
     * 
    ...
    /**
     * Get the completedAt property: T The Unix timestamp (in seconds) for when the run step completed..
     * 
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeUntypedField("step_details", this.stepDetails.toObject(Object.class));
    ...
    public static RunStepObject fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            return new RunStepObject(id, createdAt, assistantId, threadId, runId, type, status, stepDetails, lastError,
                expiresAt, cancelledAt, failedAt, completedAt, metadata, usage);
        });
    }
}
