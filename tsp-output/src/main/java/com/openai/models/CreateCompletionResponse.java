...
public final class CreateCompletionResponse implements JsonSerializable<CreateCompletionResponse> {
     ...
     */
    @Metadata(generated = true)
    private CreateCompletionResponse(String id, List<CreateCompletionResponseChoices> choices, OffsetDateTime created,
        String model) {
        this.id = id;
    ...
    /**
     * Get the usage property: Usage statistics for the completion request.
     * 
