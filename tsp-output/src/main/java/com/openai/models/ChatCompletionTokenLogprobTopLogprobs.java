...
/**
 * The ChatCompletionTokenLogprobTopLogprobs model.
 */
@Metadata(conditions = { TypeConditions.IMMUTABLE })
public final class ChatCompletionTokenLogprobTopLogprobs
    implements JsonSerializable<ChatCompletionTokenLogprobTopLogprobs> {
    /*
     * The token.
     */
    ...
    /**
     * Creates an instance of ChatCompletionTokenLogprobTopLogprobs class.
     * 
     ...
     */
    @Metadata(generated = true)
    private ChatCompletionTokenLogprobTopLogprobs(String token, double logprob, List<Long> bytes) {
        this.token = token;
    ...
    /**
     * Get the logprob property: The log probability of this token.
     * 
    ...
    /**
     * Reads an instance of ChatCompletionTokenLogprobTopLogprobs from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of ChatCompletionTokenLogprobTopLogprobs if the JsonReader was pointing to an instance of it,
     * or null if it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the ChatCompletionTokenLogprobTopLogprobs.
     */
    @Metadata(generated = true)
    public static ChatCompletionTokenLogprobTopLogprobs fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            return new ChatCompletionTokenLogprobTopLogprobs(token, logprob, bytes);
        });
    }
}
