...
/**
 * The ListAssistantFilesResponse model.
 */
@Metadata(conditions = { TypeConditions.IMMUTABLE })
public final class ListAssistantFilesResponse implements JsonSerializable<ListAssistantFilesResponse> {
    /*
     * The object property.
     */
     ...
     */
    @Metadata(generated = true)
    private final List<AssistantFileObject> data;
    ...
    /**
     * Creates an instance of ListAssistantFilesResponse class.
     * 
     ...
     */
    @Metadata(generated = true)
    private ListAssistantFilesResponse(List<AssistantFileObject> data, String firstId, String lastId, boolean hasMore) {
        this.data = data;
    ...
    /**
     * Reads an instance of ListAssistantFilesResponse from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of ListAssistantFilesResponse if the JsonReader was pointing to an instance of it, or null if
     * it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the ListAssistantFilesResponse.
     */
    @Metadata(generated = true)
    public static ListAssistantFilesResponse fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            List<AssistantFileObject> data = null;
            String firstId = null;
            String lastId = null;
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("data".equals(fieldName)) {
                    data = reader.readArray(reader1 -> AssistantFileObject.fromJson(reader1));
            ...
            return new ListAssistantFilesResponse(data, firstId, lastId, hasMore);
        });
    }
}
