...
/**
 * The ChatCompletionRequestSystemMessage model.
 */
@Metadata(conditions = { TypeConditions.FLUENT })
public final class ChatCompletionRequestSystemMessage implements JsonSerializable<ChatCompletionRequestSystemMessage> {
    /*
    ...
    /**
     * Get the role property: The role of the messages author, in this case `system`.
     * 
