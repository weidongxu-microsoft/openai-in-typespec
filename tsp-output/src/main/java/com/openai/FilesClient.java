...
public final class FilesClient {
    ...
    Response<BinaryData> createFileWithResponse(BinaryData file, RequestOptions requestOptions) {
        // Protocol API requires serialization of parts with content-disposition and data, as operation 'createFile' is 'multipart/form-data'
    ...
    public OpenAIFile createFile(CreateFileRequest file) {
        ...
        return createFileWithResponse(new MultipartFormDataHelper(requestOptions)
            .serializeFileField("file", file.getFile().getContent(), file.getFile().getContentType(),
                file.getFile().getFilename())
            .serializeTextField("purpose", Objects.toString(file.getPurpose()))
            .end()
