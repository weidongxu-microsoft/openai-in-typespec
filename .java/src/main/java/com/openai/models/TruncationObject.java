...
public final class TruncationObject implements JsonSerializable<TruncationObject> {
     ...
     * be truncated to the n most recent messages in the thread. When set to `auto`, messages in the middle of the
     * thread will be dropped to fit the context length of the model, `max_prompt_tokens`.
     */
    @Generated
    private final TruncationObjectType type;
    ...
    public static TruncationObject fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            TruncationObjectType type = null;
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("type".equals(fieldName)) {
                    type = TruncationObjectType.fromString(reader.getString());
