...
public final class MessageObject implements JsonSerializable<MessageObject> {
    ...
    private MessageObject(String id, OffsetDateTime createdAt, String threadId, MessageObjectStatus status,
        ...
        MessageObjectRole role, List<MessageContent> content, String assistantId, String runId,
        List<MessageObjectAttachment> attachments, Map<String, String> metadata) {
        this.id = id;
        if (createdAt == null) {
            this.createdAt = 0L;
        } else {
    ...
    public static MessageObject fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            return new MessageObject(id, createdAt, threadId, status, incompleteDetails, completedAt, incompleteAt,
