...
/**
 * The ListAssistantsResponse model.
 */
@Immutable
public final class ListAssistantsResponse implements JsonSerializable<ListAssistantsResponse> {
    /*
     * The object property.
     */
    @Generated
     ...
     */
    @Generated
    private final List<AssistantObject> data;
    ...
    /**
     * Creates an instance of ListAssistantsResponse class.
     * 
     ...
     */
    @Generated
    private ListAssistantsResponse(List<AssistantObject> data, String firstId, String lastId, boolean hasMore) {
        this.data = data;
    ...
    /**
     * Reads an instance of ListAssistantsResponse from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of ListAssistantsResponse if the JsonReader was pointing to an instance of it, or null if it
     * was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the ListAssistantsResponse.
     */
    @Generated
    public static ListAssistantsResponse fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            List<AssistantObject> data = null;
            String firstId = null;
            String lastId = null;
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("data".equals(fieldName)) {
                    data = reader.readArray(reader1 -> AssistantObject.fromJson(reader1));
            ...
            return new ListAssistantsResponse(data, firstId, lastId, hasMore);
        });
    }
}
