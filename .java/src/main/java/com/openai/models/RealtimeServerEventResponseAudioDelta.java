 ...
 */
@Immutable
public final class RealtimeServerEventResponseAudioDelta extends RealtimeServerEvent {
    /*
     * The type property.
     */
    @Generated
    ...
    /**
     * Creates an instance of RealtimeServerEventResponseAudioDelta class.
     * 
     ...
     */
    @Generated
    private RealtimeServerEventResponseAudioDelta(String eventId, String responseId, String itemId, int outputIndex,
        int contentIndex, byte[] delta) {
        super(eventId);
    ...
    /**
     * Reads an instance of RealtimeServerEventResponseAudioDelta from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of RealtimeServerEventResponseAudioDelta if the JsonReader was pointing to an instance of it,
     * or null if it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the RealtimeServerEventResponseAudioDelta.
     */
    @Generated
