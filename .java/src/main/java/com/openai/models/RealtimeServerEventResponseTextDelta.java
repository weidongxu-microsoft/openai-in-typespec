 ...
 */
@Immutable
public final class RealtimeServerEventResponseTextDelta extends RealtimeServerEvent {
    /*
     * The type property.
     */
    @Generated
    ...
    /**
     * Creates an instance of RealtimeServerEventResponseTextDelta class.
     * 
     ...
     */
    @Generated
    private RealtimeServerEventResponseTextDelta(String eventId, String responseId, String itemId, int outputIndex,
    ...
    /**
     * Reads an instance of RealtimeServerEventResponseTextDelta from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of RealtimeServerEventResponseTextDelta if the JsonReader was pointing to an instance of it,
     * or null if it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the RealtimeServerEventResponseTextDelta.
     */
    @Generated
    public static RealtimeServerEventResponseTextDelta fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            int contentIndex = 0;
            String delta = null;
            RealtimeServerEventType type = RealtimeServerEventType.RESPONSE_TEXT_DELTA;
