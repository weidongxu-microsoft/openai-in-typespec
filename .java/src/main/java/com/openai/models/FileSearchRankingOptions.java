...
public final class FileSearchRankingOptions implements JsonSerializable<FileSearchRankingOptions> {
     ...
     */
    @Generated
    private FileSearchRankingOptionsRanker ranker;
    ...
    /**
     * Get the ranker property: The ranker to use for the file search. If not specified will use the `auto` ranker.
     * 
     * @return the ranker value.
     */
    @Generated
    public FileSearchRankingOptionsRanker getRanker() {
        return this.ranker;
    }

    /**
     * Set the ranker property: The ranker to use for the file search. If not specified will use the `auto` ranker.
     * 
     * @param ranker the ranker value to set.
     * @return the FileSearchRankingOptions object itself.
     */
    @Generated
    public FileSearchRankingOptions setRanker(FileSearchRankingOptionsRanker ranker) {
        this.ranker = ranker;
        return this;
    }
    ...
    public static FileSearchRankingOptions fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            FileSearchRankingOptionsRanker ranker = null;
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("score_threshold".equals(fieldName)) {
                    ...
                    ranker = FileSearchRankingOptionsRanker.fromString(reader.getString());
                } else {
                    reader.skipChildren();
                }
            }
