...
/**
 * The ListRunStepsResponse model.
 */
@Immutable
public final class ListRunStepsResponse implements JsonSerializable<ListRunStepsResponse> {
    /*
     * The object property.
     */
    @Generated
     ...
     */
    @Generated
    private final List<RunStepObject> data;
    ...
    /**
     * Creates an instance of ListRunStepsResponse class.
     * 
     ...
     */
    @Generated
    private ListRunStepsResponse(List<RunStepObject> data, String firstId, String lastId, boolean hasMore) {
        this.data = data;
    ...
    /**
     * Reads an instance of ListRunStepsResponse from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of ListRunStepsResponse if the JsonReader was pointing to an instance of it, or null if it
     * was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the ListRunStepsResponse.
     */
    @Generated
    public static ListRunStepsResponse fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            List<RunStepObject> data = null;
            String firstId = null;
            String lastId = null;
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("data".equals(fieldName)) {
                    data = reader.readArray(reader1 -> RunStepObject.fromJson(reader1));
            ...
            return new ListRunStepsResponse(data, firstId, lastId, hasMore);
        });
    }
}
