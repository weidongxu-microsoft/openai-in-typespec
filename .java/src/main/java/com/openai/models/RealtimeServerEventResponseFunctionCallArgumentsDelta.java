...
public final class RealtimeServerEventResponseFunctionCallArgumentsDelta extends RealtimeServerEvent {
    /*
     * The type property.
     */
    ...
    /**
     * Creates an instance of RealtimeServerEventResponseFunctionCallArgumentsDelta class.
     * 
     ...
     */
    @Metadata(generated = true)
    private RealtimeServerEventResponseFunctionCallArgumentsDelta(String eventId, String responseId, String itemId,
    ...
    /**
     * Reads an instance of RealtimeServerEventResponseFunctionCallArgumentsDelta from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of RealtimeServerEventResponseFunctionCallArgumentsDelta if the JsonReader was pointing to an
     * instance of it, or null if it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the RealtimeServerEventResponseFunctionCallArgumentsDelta.
     */
    @Metadata(generated = true)
    public static RealtimeServerEventResponseFunctionCallArgumentsDelta fromJson(JsonReader jsonReader)
        throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            String callId = null;
            String delta = null;
            RealtimeServerEventType type = RealtimeServerEventType.RESPONSE_FUNCTION_CALL_ARGUMENTS_DELTA;
            ...
            RealtimeServerEventResponseFunctionCallArgumentsDelta deserializedRealtimeServerEventResponseFunctionCallArgumentsDelta
                = new RealtimeServerEventResponseFunctionCallArgumentsDelta(eventId, responseId, itemId, outputIndex,
                    callId, delta);
            deserializedRealtimeServerEventResponseFunctionCallArgumentsDelta.type = type;

            return deserializedRealtimeServerEventResponseFunctionCallArgumentsDelta;
        });
    }
}
