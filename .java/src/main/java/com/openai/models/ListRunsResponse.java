...
/**
 * The ListRunsResponse model.
 */
@Immutable
public final class ListRunsResponse implements JsonSerializable<ListRunsResponse> {
    /*
     * The object property.
     */
    @Generated
     ...
     */
    @Generated
    private final List<RunObject> data;
    ...
    /**
     * Creates an instance of ListRunsResponse class.
     * 
     ...
     */
    @Generated
    private ListRunsResponse(List<RunObject> data, String firstId, String lastId, boolean hasMore) {
        this.data = data;
    ...
    /**
     * Reads an instance of ListRunsResponse from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of ListRunsResponse if the JsonReader was pointing to an instance of it, or null if it was
     * pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the ListRunsResponse.
     */
    @Generated
    public static ListRunsResponse fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            List<RunObject> data = null;
            String firstId = null;
            String lastId = null;
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("data".equals(fieldName)) {
                    data = reader.readArray(reader1 -> RunObject.fromJson(reader1));
            ...
            return new ListRunsResponse(data, firstId, lastId, hasMore);
        });
    }
}
