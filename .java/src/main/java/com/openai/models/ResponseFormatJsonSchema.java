...
/**
 * The ResponseFormatJsonSchema model.
 */
@Immutable
public final class ResponseFormatJsonSchema extends OmniTypedResponseFormat {
    /*
     * The type property.
     */
    @Generated
     ...
     */
    @Generated
    public ResponseFormatJsonSchema(ResponseFormatJsonSchemaJsonSchema jsonSchema) {
    ...
    public static ResponseFormatJsonSchema fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            ResponseFormatJsonSchema deserializedResponseFormatJsonSchema = new ResponseFormatJsonSchema(jsonSchema);
            deserializedResponseFormatJsonSchema.type = type;
