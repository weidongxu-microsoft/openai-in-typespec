...
public class ChatCompletionRequestAssistantMessage extends ChatCompletionRequestMessage {
    ...
    public static ChatCompletionRequestAssistantMessage fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            try (JsonReader readerToUse = reader.bufferObject()) {
                ...
                if ("FineTuneChatCompletionRequestAssistantMessage".equals(discriminatorValue)) {
                    return FineTuneChatCompletionRequestAssistantMessage.fromJson(readerToUse.reset());
                } else {
    ...
    @Generated
    static ChatCompletionRequestAssistantMessage fromJsonKnownDiscriminator(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
