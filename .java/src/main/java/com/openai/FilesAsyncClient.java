...
/**
 * Initializes a new instance of the asynchronous Files type.
 */
...
public final class FilesAsyncClient {
    ...
    Mono<Response<BinaryData>> createFileWithResponse(BinaryData requestBody, RequestOptions requestOptions) {
        // Protocol API requires serialization of parts with content-disposition and data, as operation 'createFile' is
        // 'multipart/form-data'
        return this.serviceClient.createFileWithResponseAsync(requestBody, requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> downloadFileWithResponse(String fileId, RequestOptions requestOptions) {
        return this.serviceClient.downloadFileWithResponseAsync(fileId, requestOptions);
    }
     ...
     * @return the `File` object represents a document that has been uploaded to OpenAI on successful completion of
     * {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<OpenAIFile> createFile(CreateFileRequest requestBody) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ListFilesResponse> listFiles(String purpose) {
        ...
        return listFilesWithResponse(requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(ListFilesResponse.class));
    }
    ...
    public Mono<DeleteFileResponse> deleteFile(String fileId) {
        ...
        return deleteFileWithResponse(fileId, requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(DeleteFileResponse.class));
    }
    ...
    public Mono<byte[]> downloadFile(String fileId) {
        ...
        RequestOptions requestOptions = new RequestOptions();
        return downloadFileWithResponse(fileId, requestOptions).flatMap(FluxUtil::toMono)
