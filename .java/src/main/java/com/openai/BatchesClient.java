...
public final class BatchesClient {
    ...
    public ListBatchesResponse listBatches(String after, Integer limit) {
        ...
        return listBatchesWithResponse(requestOptions).getValue().toObject(ListBatchesResponse.class);
    }
    ...
    public Batch retrieveBatch(String batchId) {
        ...
        RequestOptions requestOptions = new RequestOptions();
        return retrieveBatchWithResponse(batchId, requestOptions).getValue().toObject(Batch.class);
    }
