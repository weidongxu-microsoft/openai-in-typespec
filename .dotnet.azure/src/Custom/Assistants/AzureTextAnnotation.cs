...
public static class TextAnnotationExtensions
{
    /// <summary>
    ...
    public static bool IsBingSearchAnnotation(this TextAnnotation baseAnnotation)
    {
    ...
    [Experimental("AOAI001")]
    public static string GetBingSearchTitle(this TextAnnotation baseAnnotation)
    {
    ...
    [Experimental("AOAI001")]
    public static Uri GetBingSearchUrl(this TextAnnotation baseAnnotation)
    {
